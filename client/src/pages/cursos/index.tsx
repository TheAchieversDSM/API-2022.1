                ...
                <div className="conteudo">
                    <div className="row">
                        ...
                        <div className="col s12 m12 l5">
                            <div className="teste3">
                                <p>
                                    {this.state.colaborador.map(info => <p><label>Aula</label></p>)}
                    ...
                    <div className="Buttom">
                            <ButtonMat fname={this.handleSubmit} class="waves-effect waves-light btn center-align" name="" iClass="fa-solid fa-arrow-left-long"></ButtonMat>
                            <ButtonMat fname={this.handleSubmit} class="waves-effect waves-light btn center-align" name="" iClass="fa-solid fa-arrow-right-long"></ButtonMat>
                    </div>
