                    ...
                    <div className="col s8">
                        <div className="teste3">
                            <ul className="collapsible popout" data-collapsible="accordion">
                                ...
                                desc1={ this.state.info_acad.map(info => <p key={info.colaborador_con_id}>Formação: {info.qua_formacao}</p>)}
                                desc2={ this.state.info_acad.map(info => <p key={info.colaborador_con_id}>Instituição: {info.qua_nome_instituicao}</p>)}
                                desc3={ this.state.info_acad.map(info => <p key={info.colaborador_con_id}>Curso: {info.qua_curso}</p>)}
                                desc4={ this.state.info_acad.map(info => <p key={info.colaborador_con_id}>Línguas: {info.qua_lingua}</p>)}
                                desc5={null} 
                                desc6={null}/>
                                ...
                                desc1={ this.state.info_pf.map(info => <p key={info.colaborador_con_id}>Estado Civil: {info.user_estado_civil}</p>)}
                                ...
                                desc1={ this.state.info_pf.map(info => <p key={info.colaborador_con_id}>Dependentes: {info.user_filho}</p>)} 
