                    ...
                    <div className="row">
                        <ul className="collapsible popout" data-collapsible="accordion">
                            <li>
                                ...
                                <div className=" collapsible-body campo1">
                                    <div className="row">
                                    <h5 className="titulo">Dados Pessoais</h5>
                                        <form className="col s12">
                                            ...
                                            <div className="row">
                                                <Input fname={this.handleChangeCPF} div="input-field col s7" id="cpf" class="validate" type="text" name="CPF" />
                                            </div>

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s5" id="nacionalidade" class="validate" type="text" name="Nacionalidade" />
                                                <Input fname={this.handleChangeNaturalidade} div="input-field col s7" id="naturalidade" class="validate" type="text" name="Naturalidade" />
                                            </div>
                                            ...
                                            <div className="row">
                                                <Input fname={this.handleChangeData} div="input-field col s6" id="data" class="datepicker" type="date" name="Data de Nascimento" />
                                            </div>
                                ...
                                <div className=" collapsible-body campo1">
                                    <div className="row">
                                        <form className="col s12">
                                            ...
                                            <div className="row">
                                                <Input fname={this.handleChangeRua} div="input-field col s9 bla" id="rua" class="validate" type="text" name="Rua" />  
                                                <Input fname={this.handleChangeNumero} div="input-field col s3 bla" id="numero" class="validate" type="number" name="Número" />
                                            </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="input-field col s3 bla">
                                ...
                                <div className=" collapsible-body campo1">
                                    <div className="row">
                                        ...
                                        <h5 className="titulo">Dados Acadêmicos</h5>
                                                <div className="row">
                                                    <Input fname={this.handleChangeFormacao} div="input-field col s5 bla" id="formacao" type="text" class="validate" name="Formação" />

                                                    <Input fname={this.handleChangeCursos} div="input-field col s7 bla" id="cursos" type="text" class="validate" name="Cursos" />
                            ...
                            <li>
                                ...
                                <div className=" collapsible-body campo2">
                                <div className="row">
                                        <form className="col s12">

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s5" id="rg" class="validate" type="text" name="RG" />
                                                <Input fname={this.handleChangeNaturalidade} div="input-field col s7" id="carteiradetrabalho" class="validate" type="text" name="Carteira de Trabalho" />
                                                
                                            </div>

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s5" id="cpf" class="validate" type="text" name="CPF" />
                                                <Input fname={this.handleChangeNaturalidade} div="input-field col s7" id="cnh" class="validate" type="text" name="CNH" />
                                            </div>

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s5" id="foto" class="validate" type="text" name="Foto(3x4)" />
                                                <Input fname={this.handleChangeNaturalidade} div="input-field col s7" id="titulodeeleitor" class="validate" type="text" name="Título de Eleitor" />
                                            </div>

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s5" id="comprovantederesidencia" class="validate" type="text" name="Comprovante de Residência" />
                                                <Input fname={this.handleChangeNaturalidade} div="input-field col s7" id="copiadocartao" class="validate" type="text" name="Copia do Cartão do Banco" />
                                            </div>
                            ...
                            <li>
                                ...
                                <div className=" collapsible-body campo3">
                                <div className="row">
                                        <form className="col s12">
                            ...
                            <li>
                                ...
                                <div className=" collapsible-body campo4">
                                <div className="row">
                                        <form className="col s12">

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s5" id="comtrubuicao" class="validate" type="text" name="Contribução Sindical" />
                                                <Input fname={this.handleChangeNaturalidade} div="input-field col s7" id="termo" class="validate" type="text" name="Termo de PI" />
                                                
                                            </div>

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s5" id="pis" class="validate" type="text" name="Cartão do PIS" />
                                                <Input fname={this.handleChangeNaturalidade} div="input-field col s7" id="reservista" class="validate" type="text" name="Certificado de Reservista" />
                                            </div>

                                            <div className="row">
                                                <Input fname={this.handleChangeNacionalidade} div="input-field col s6" id="atestadosaude" class="validate" type="text" name="Atestado de Saúde Ocupacional" />
                                            </div>
                            ...
                            <li>
                                ...
                                <div className=" collapsible-body campo5">
                                <div className="row">
                                        <form className="col s12">
                            ...
                            <li>
                                ...
                                <div className=" collapsible-body campo6">
                                <div className="row">
                                        <form className="col s12">
