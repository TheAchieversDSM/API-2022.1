        ...
        return (
            <>
                ...
                <div className="conteudo">
                    <h2>Novo Perfil</h2>
                    <div className="form">
                        <Input div="input-field col s12" type="email" id="email" name="email" class="validate" fname={this.handleChange} />
                        <Input div="input-field col s12" type="password" id="password" name="password" class="validate" fname={this.handleChange} />
