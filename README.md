...
Sprint ID | Tag | Status
----------|-----|--------
#1 | :construction: | :construction:
#2 | :stop_sign: | :stop_sign:
#3 | :stop_sign: | :stop_sign:
