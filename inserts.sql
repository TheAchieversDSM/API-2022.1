...
INSERT INTO colaborador (con_email, con_senha, con_nome, con_ddd, con_telefone, end_rua, end_numero, end_bairro, end_cep, end_estado, end_complemento, end_regiao, tipo_contratacao_cont_id, cargo_car_id, departamento_dep_id, tipo_pessoa, head_id) VALUES ("gabriel.telles@ionic.health", "1234", "Leonardo Salles", "12", "986571245", "Rua Estados Unidos", "47", "Vista Verde", "12245134", "SP", "", "Sudeste", "1", "76", "6  ", "Física", 17);
...
SELECT con_id, con_nome, car_descricao, dep_descricao FROM colaborador colab INNER JOIN cargo car INNER JOIN departamento dep ON colab.cargo_car_id = car.car_id AND colab.departamento_dep_id = dep.dep_id;
