                ...
                <div className="func">
                 <input type="text" id="searchBox" onKeyUp={this.search} placeholder="Procure por um nome..."/>
                        <table id="tabela">
                            ...
                            <tbody>                  
                                    {this.state.cargos.map(car => <TRSem key={car.car_id} urlVisualizacao={`/PerfilColaborador/${car.car_id}`} urlEdicao={''}  nome={car.car_descricao} departamento={car.car_salario} cargo={""} />)}
